...
function calculateDiscountedPrice(item: TDiscount & TProduct):number {
    return item.price * (1 - item.discountPercentage / 100)
}

// 테스트 코드
const discountedProduct: TDiscount & TProduct = {
  id: 101,
  name: "Laptop",
  price: 1000,
...
// 사용자 요약 정보를 반환하는 함수
function getUserSummary(user: IProfile & TActivity): string {
